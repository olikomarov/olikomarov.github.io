...
function chooseData() {
    ...
    var dropDownMenu = d3.select("#dataset"),
        selectedDemension = dropDownMenu.select(`option:nth-child(${dropDownMenu.property("selectedIndex") + 1})`)
                                        .property('value');

    barChart.updateBarChart(selectedDemension);
